  ...
  <div class="content-wrapper">
    ...
    <div class="invoice-header">
      ...
      <div class="float-right site-address">
        ...
        <p>Email: <a href="mailto:info@demo_ecommerce.com">info@demo_ecommerce.com</a></p>
      </div>
        ...
        <table class="table table-bordered table-stripe">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="2">
                <strong>  {{ $order->coustom_discount }} Taka</strong>
              </td>
            </tr>
            <tr>
              <td colspan="3"></td>
            ...
            <tr>
              ...
              <td colspan="2">
                <strong>  {{ $total_price + $order->shipping_cost - $order->coustom_discount }} Taka</strong>
              </td>
            </tr>
          </tbody>
        </table>
