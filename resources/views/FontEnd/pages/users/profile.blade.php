        ...
        <div class="card-body">
                    <form method="POST" action="{{ route('user.profile.update') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone_no" type="phone_no" class="form-control @error('phone_no') is-invalid @enderror" name="phone_no" value="{{ $user->phone_no }}"  autocomplete="phone_no">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="street_address" type="street_address" class="form-control @error('street_address') is-invalid @enderror" name="street_address" value="{{ $user->street_address }}"  autocomplete="street_address">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="shipping_address" type="text" class="form-control @error('shipping_address') is-invalid @enderror" name="shipping_address" rows="4" autocomplete="shipping_address"> {{ $user->shipping_address }} </textarea>
